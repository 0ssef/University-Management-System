...
void MAIN_MENU(List *list_ptr) {
    ...
    printf("Hi Eng. Mohamed Abdallah ,welcome to EIG Team University Management System!!\n\n\n");
    ...
    printf(" 4 >> Update student total score\n");
    printf(" 5 >> Rank students according to their total scores\n");
    printf(" 6 >> Display Student List according to alphabetics\n");
    printf(" 7 >> Exit\n\n\n");
    ...
    switch (choose) {
        ...
        case 5: {
            /* Option 5: Rank students according to their total score */
...
static void GET_DATA(student_node *new_std) {
    ...
    printf("Please enter student total score : ");
...
void EDIT_STUDENT_DATA(List *list_ptr) {
    ...
    if (student_to_edit != NULL) {
        ...
        printf("Enter new student total score: ");
        scanf("%i", &student_to_edit->student_data.c_science_score);
...
void UPDATE_ALL_SCORES(List *list_ptr) {
    ...
    while (current != NULL) {
        printf("Enter new total score for student %s: ", current->student_data.name);
    ...
    printf("All students' total scores have been updated successfully.\n");
}
...
/*Function to rank student according to grades */
void RANK_STUDENTS(List *list_ptr) {
    ...
    /* Perform  sort on the students_array based on total scores */
    ...
    /*Display the students with the highest total scores*/
    printf("Students with the highest total scores:\n");
...
void DISPLAY_STUDENT_LIST(List *list_ptr) {
    ...
    printf("----------------------------------------------------------------------------------------------------------------------------\n");
    printf("| %-5s | %-20s | %-10s | %-30s | %-12s | %-12s | %-8s |\n", "No.", "Name", "ID", "Address", "Birth Date", "Phone Number", "Total Score");
    printf("----------------------------------------------------------------------------------------------------------------------------\n");
